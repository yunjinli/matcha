...
#
# Code from: https://github.com/naver/croco/blob/master/models/pos_embed.py
...
def get_2d_sincos_pos_embed(embed_dim, grid_size, n_cls_token=0):
    ...
    grid = np.meshgrid(grid_w, grid_h, indexing="ij")  # here w goes first
...
try:
    from src.curope import cuRoPE2D
